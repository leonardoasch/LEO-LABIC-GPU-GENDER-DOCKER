...
validation_generator = test_datagen.flow_from_directory(IMAGES_FOLDER,
                                                        target_size=(
                                                            IMAGE_SIZE, IMAGE_SIZE),
                                                        batch_size=BATCH_SIZE,
                                                        class_mode='categorical',
                                                        shuffle=False,
                                                        save_to_dir='/home/users/ramosrafh/git/YoloKerasFaceDetection/dataset/generator/gen'
                                                        )
...
Y_pred = keras_model.predict_generator(
    ...
    validation_generator, validation_data_n//BATCH_SIZE + 1, verbose=1)
