...
if EXTRA_MODE != "hdf5":
    ...
    train_generator = train_datagen.flow_from_directory(
        ...
        save_to_dir='/home/users/ramosrafh/git/YoloKerasFaceDetection/dataset/agegender_imdb/test/train/train/',
    ...
    validation_generator = test_datagen.flow_from_directory(
        ...
        target_size=(IMAGE_SIZE, IMAGE_SIZE),
        batch_size=BATCH_SIZE,
        save_to_dir='/home/users/ramosrafh/git/YoloKerasFaceDetection/dataset/agegender_imdb/test/train/validation/',
        class_mode='categorical',
        shuffle=True
    )
...
y_pred = (pred > 0.5)
matrix = confusion_matrix(validY.argmax(axis=1), y_pred.argmax(axis=1))
